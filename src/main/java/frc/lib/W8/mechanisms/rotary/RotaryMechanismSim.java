...
import frc.lib.W8.io.absoluteencoder.AbsoluteEncoderIOSim;
...
public class RotaryMechanismSim extends RotaryMechanism {
  ...
  public void periodic() {
    ...
    absoluteEncoderSim.ifPresent(
        encoderSim -> {
          encoderSim.setAngle(Radians.of(sim.getAngleRads()).times(io.getSensorToMechanismRatio()));
          encoderSim.setAngularVelocity(
