...
import frc.lib.W8.util.LaserCANConfigurator;
...
public class DistanceSensorIOLaserCAN implements DistanceSensorIO {
  ...
  /**
   * Constructs a new {@link DistanceSensorIOLaserCAN} with specified parameters and configuration.
   *
  ...
  public DistanceSensorIOLaserCAN(
    ...
    invalidReadingAlert = new Alert("LaserCAN " + name + " reading is invalid", AlertType.kWarning);
    ...
    updateThread.LaserCANCheckErrorAndRetry(() -> laserCAN.setRegionOfInterest(regionOfInterest));
