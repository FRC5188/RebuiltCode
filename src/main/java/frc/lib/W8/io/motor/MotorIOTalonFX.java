...
public class MotorIOTalonFX implements MotorIO {
   ...
   */
  public record TalonFXFollower(Device.CAN id, MotorAlignmentValue opposesMain) {}
   ...
   *
   * <p>Position control modes command the motor to move to and hold a specific position. This
   ...
   *
   * <p>Velocity control modes command the motor to spin at a specific speed.
   *
   ...
   *
   * <p>Motion Magic is CTRE's advanced motion profiling control mode that automatically generates
   ...
   *
   * <p>This identifies which control mode the motor is currently in (coast, brake, voltage,
   ...
   *
   * <p>This method refreshes all status signals from the motor and populates the inputs object with
   ...
   *
   * <p>In coast mode, the motor spins freely when not powered. The mechanism will slow down
   * gradually due to friction but won't actively try to stop. Use this when you want the mechanism
   * to move freely.
   */
  @Override
   ...
   *
   * <p>In brake mode, the motor actively resists rotation when not powered. This causes the
   ...
   *
   * <p>Voltage control directly applies a voltage to the motor.
   *
   ...
   *
   * <p>Current control directly controls the current flowing through the motor, which is
   * proportional to torque output. This provides more consistent torque regardless of motor speed,
   * compared to voltage control.
   *
   ...
   *
   * <p>This version allows you to limit the maximum speed of the motor while using current control.
   ...
   *
   * <p>Duty cycle control outputs a percentage of the current battery voltage. Unlike direct
   * voltage control, this automatically adjusts for battery voltage changes.
   *
   ...
   *
   * <p>Motion Magic generates a smooth motion profile with controlled cruise velocity,
   * acceleration, and jerk. Dynamic Motion Magic allows these parameters to be changed on-the-fly
   * for each new position command. This provides smooth, predictable motion that's easy on
   * mechanisms and looks professional.
   *
   ...
   *
   * <p>Velocity control maintains a constant speed using a PID controller. The motor will
   ...
   *
   * <p>This is useful for zeroing the encoder when the mechanism is at a known position, or for
   * resetting position after hitting a hard stop. Use carefully as incorrect position can cause the
   * mechanism to move unexpectedly.
   *
