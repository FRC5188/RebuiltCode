...
public interface AbsoluteEncoderIO {
  ...
  /**
   * Updates the provided {@link AbsoluteEncoderInputs} instance with the latest sensor readings. If
   * the sensor is not connected, it populates the fields with default values.
   *
