...
package frc.lib.W8.io.absoluteencoder;
...
public class AbsoluteEncoderIOCANCoder implements AbsoluteEncoderIO {
  ...
  public AbsoluteEncoderIOCANCoder(
      Device.CAN id, String name, CANcoderConfiguration configuration) {
    this.name = name;
    ...
    // Further reduce update frequency for absolute encoder since it's mainly used for initialization
    updateThread.CTRECheckErrorAndRetry(() -> angle.setUpdateFrequency(10.0)); // Further reduced from 25.0
