...
public class ObjectDetectionIOPhotonVision implements ObjectDetectionIO {
  ...
  public void updateInputs(ObjectDetectionIOInputs inputs) {
    ...
    for (int i = 0; i < TargetSize; i++) {
      double[] corner1 = {
        currentTargets.get(i).getMinAreaRectCorners().get(0).x,
        currentTargets.get(i).getMinAreaRectCorners().get(0).y
      };
      double[] corner2 = {
        currentTargets.get(i).getMinAreaRectCorners().get(1).x,
        currentTargets.get(i).getMinAreaRectCorners().get(1).y
      };
      double[] corner3 = {
        currentTargets.get(i).getMinAreaRectCorners().get(2).x,
        currentTargets.get(i).getMinAreaRectCorners().get(2).y
      };
      double[] corner4 = {
        currentTargets.get(i).getMinAreaRectCorners().get(3).x,
