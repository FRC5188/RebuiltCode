...
public class FieldUtil {
  ...
  public static Pose2d handleAllianceFlip(Pose2d blue_pose) {
    return shouldFlip() ? blue_pose.rotateAround(fieldCenter, Rotation2d.k180deg) : blue_pose;
  }

  public static Translation2d handleAllianceFlip(Translation2d blue_translation) {
    return shouldFlip()
        ? blue_translation.rotateAround(fieldCenter, Rotation2d.k180deg)
        : blue_translation;
  }
