...
public final class Constants {
  ...
  public class FieldConstants {
    ...
    public static final Distance neutralZoneNear = Meters.of(CENTERLINE.in(Meters) - (Units.inchesToMeters(120.0)));
    public static final Distance neutralZoneFar = Meters.of(CENTERLINE.in(Meters) + (Units.inchesToMeters(120.0)));
